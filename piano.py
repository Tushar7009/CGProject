...
def piano(event):
    ...
    if num=="Q" or num=="q":
        ...
        W1.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\A.wav')
        sound.play()
        ...
        W2.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\B.wav')
        sound.play()
        master.after(100,lambda: W2.config(bg="white"))

    elif num=="e" or num=="E":
        W3.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\Bb.wav')
        sound.play()
        master.after(100,lambda: W3.config(bg="white"))

    elif num=="R" or num=="r":
        W4.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\C_s.wav')
        sound.play()
        master.after(100,lambda: W4.config(bg="white"))

    elif num=="t" or num=="T":
        W5.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\C_s1.wav')
        sound.play()
        master.after(100,lambda: W5.config(bg="white"))

    elif num=="Y" or num=="y":
        W6.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\C1.wav')
        sound.play()
        master.after(100,lambda: W6.config(bg="white"))

    elif num=="u" or num=="U":
        W7.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\D.wav')
        sound.play()
        master.after(100,lambda: W7.config(bg="white"))

    elif num=="A" or num=="a":
        W8.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\D_s.wav')
        sound.play()
        master.after(100,lambda: W8.config(bg="white"))

    elif num=="s" or num=="S":
        W9.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\D_s1.wav')
        sound.play()
        master.after(100,lambda: W9.config(bg="white"))

    elif num=="D" or num=="d":
        W10.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\D1.wav')
        sound.play()
        master.after(100,lambda: W10.config(bg="white"))

    elif num=="F" or num=="f":
        W11.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\E.wav')
        sound.play()
        master.after(100,lambda: W11.config(bg="white"))

    elif num=="G" or num=="g":
        W12.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\F.wav')
        sound.play()
        master.after(100,lambda: W12.config(bg="white"))

    elif num=="H" or num=="h":
        W13.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\F_s.wav')
        sound.play()
        master.after(100,lambda: W13.config(bg="white"))

    elif num=="J" or num=="j":
        W14.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\F1.wav')
        sound.play()
        master.after(100,lambda: W14.config(bg="white"))

    elif num=="1":
        B1.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\G.wav')
        sound.play()
        master.after(100,lambda: B1.config(bg="black"))

    elif num=="2" :
        B2.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\G_s.wav')
        sound.play()
...
def synth(event):
    ...
    if num=="Q" or num=="q":
        ...
        W1.config(bg="#66b5ff")
        sound = pygame.mixer.Sound(r'C:\Users\HITESHWAR SINGH\Desktop\Cg\CGProject\Music_Notes\Steel_Drum\A_Drum.wav')
        sound.play()
